...
*/
const WIDER_MODES = {
	"read-only": ["workspace-write", "self-checking", "danger-full-access"],
	"workspace-write": ["self-checking", "danger-full-access"],
	"self-checking": ["danger-full-access"]
};
/**
...
*/
const ESCALATION_TARGETS = ["workspace-write", "self-checking", "danger-full-access"];
/**
